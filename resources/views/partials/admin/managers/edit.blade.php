...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{@ucfirst($section_sub_title)}}</li>
    </ol>
@endsection
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{@ucfirst($section_sub_title)}}</h3>
                </div>
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{route('admin.managers.update',$model->id)}}">
                    @csrf
                    @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="email" value="{{old('email',$model->email)}}" type="email" class="form-control" id="email" placeholder="Enter email" required>
                                    @error('email')
                                    <span class="text-danger"> {{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="phone" value="{{old('phone',$model->phone)}}" type="number" class="form-control" id="phone" placeholder="Phone" required>
                                    @error('phone')
                                    <span class="text-danger"> {{$message}}</span>
                                    @enderror
                                </div>
